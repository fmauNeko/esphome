    ...
    schema = display.FULL_DISPLAY_SCHEMA.extend(
        {
            ...
            model.option(CONF_HSYNC_PIN, cv.UNDEFINED): pins.internal_gpio_output_pin_schema,
            model.option(CONF_VSYNC_PIN, cv.UNDEFINED): pins.internal_gpio_output_pin_schema,
            model.option(CONF_RESET_PIN, cv.UNDEFINED): pins.gpio_output_pin_schema,
        }
    )
    if uses_spi:
